    $(document).ready(function() {
	    ...
	    var mobile =1;
            $("#stage2").load('https://kapaweb.gr/app/login-exec.php', {"passwd": passwd, "username": escape(username), "mobile":mobile} );
        } else {
            var username = $("#username").val();
            var passwd = $("#passwd").val();
            var mobile =1;
        ...
        $("#driver").click(function(event){
            ...
            var mobile = 1;
            $("#stage").load('https://kapaweb.gr/app/login-exec.php', {"password":password,"cpassword":cpassword,"uname":uname, "mobile":mobile} );
			$("#driver").fadeIn(2000);
        });
